...
#include "App/include/switch_motor_task.h" // 스위치 모터 제어 태스크 헤더 파일 추가
...
void core0_main(void)
{
    ...
    // 새로운 FreeRTOS 태스크 생성
//     xTaskCreate(vCanMessageHandlerTask, "CAN Handler", configMINIMAL_STACK_SIZE * 2, NULL, 2, NULL);
    // xTaskCreate(vAutonomousParkingTask, "Parking", configMINIMAL_STACK_SIZE * 4, NULL, 1, NULL);
    xTaskCreate(vSwitchMotorControlTask, "Switch Motor", configMINIMAL_STACK_SIZE * 2, NULL, 1, NULL);
